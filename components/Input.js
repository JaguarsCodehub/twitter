...
const Input = () => {
    ...
    // Use this session to retrieve data from user....
    ...
    // Send POST to firebase (function)
  ...
  return (
        <div className={`border-b border-gray-800 p-3 flex space-x-3 overflow-y-scroll-hidden ${loading && "opacity-60"}`}>
            <img 

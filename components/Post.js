...
const Post = ({ id, post, postPage}) => {
    ...
    // Use session to display users info on frontend...
    const {data: session} = useSession();

    // Modal recoil state & Post Page recoil state
    ...
    // Routes to the particular post Id
    ...
    // Like functionality adding to database
